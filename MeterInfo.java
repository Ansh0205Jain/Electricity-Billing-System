...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    MeterInfo(String meternumber) {
        ...
        JLabel l1 = new JLabel("Days:");
        l1.setBounds(100, 280, 100, 20);
        p.add(l1);
        
        JLabel l2 = new JLabel("30 Days");
        l2.setBounds(240, 280, 100, 20);
        p.add(l2);
        ...
        JLabel l4 = new JLabel("By Default Bill is calculated for 30 days only");
        l4.setBounds(240, 320, 500, 20);
        p.add(l4);
